...
<input name="produc_name" type="text" /><br><br>
...
<input type="submit" name="save" value="Sale" style="font-size:12pt;color:white;background-color: MediumSeaGreen;border:2px solid #336600;padding:2px 15px;cursor:pointer;<font color='"Red"'></font>
</div>
</div>
</article>
